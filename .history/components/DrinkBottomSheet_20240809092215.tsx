...
// export function DrinkBottomSheet({ isOpen, drinkId, toggleSheet }: DrinkBottomSheetProps) {
export function DrinkBottomSheet({ isOpen, drinkId }: DrinkBottomSheetProps) {
