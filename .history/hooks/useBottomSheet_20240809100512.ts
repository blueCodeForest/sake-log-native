...
export function useBottomSheet(isOpen: SharedValue<boolean>) {
  ...
  useAnimatedReaction(
    ...
    (currentValue, previousValue) => {
      console.log('isOpen changed', currentValue, previousValue);
  ...
  return { height, sheetStyle, backdropStyle, gestureHandler, toggleSheet };
}
